...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!-- 
        ...
        pick. Tento template používa niekoľko parametrov, ktoré sa do daného templatu posielajú pomocou xsl:with-param. Best songs sú pesníčky
        z albumov s ratingom >4 a samotné majú rating >4. Worst songs sú z albumov, ktoré majú rating >3 a samotné majú rating menší ako 3, čiže
        ťahajú svoj album dole.
     -->
